...
<%
	String result = (String)request.getSession().getAttribute("exp");

	if (result == null)	pageContext.setAttribute("pexp", "0");
	else				pageContext.setAttribute("pexp", result);
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<form action="calc3" method="post" name="form">
		<table>
			<tr>
